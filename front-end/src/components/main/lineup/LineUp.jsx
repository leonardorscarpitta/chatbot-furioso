  ...
  return (
    <section className="flex flex-col gap-y-4 jusity-center items-center">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 flex-col gap-4 items-center justify-center">
        ...
        <CardLineUp nacionality="https://img.icons8.com/color/48/kazakhstan.png" playerName="molodoy" playerFunction="awper" playerImg="https://img-cdn.hltv.org/playerbodyshot/qNyAd_xVHTTmbCAKPx-jPk.png?ixlib=java-2.1.0&w=400&s=b128ede878e462107c70590202b14139" altText="imagem do jogador fallen da furia" description="Jovem talento russo, molodoy assumiu a função de AWPer na equipe, trazendo uma nova dinâmica ao time." birthDate="10/01/2005"/>
