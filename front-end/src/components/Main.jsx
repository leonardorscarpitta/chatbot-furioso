...
export default function Main() {
  let btnStyle = "text-base text-center uppercase p-4 bg-[#906C24] text-white font-bold rounded-lg hover:opacity-80 transition hover:bg-gradient-to-b hover:from-[#FCE240] hover:to-[#906C24]";
