    ...
    <LoadPage>
      <main className="flex flex-col gap-y-16 items-center">
        <section className="flex flex-col items-center text-center">
          <h3 className="text-3xl uppercase font-extrabold text-white">Entenda o que os Fãs</h3>
          <h3 className="text-3xl uppercase font-extrabold text-[#adadad]">Mais gostam na Furia ESports</h3>
        ...
        <section className="flex flex-col text-center">
          ...
          <Link href="/analisefa/pesquisa" className="m-4 p-4 bg-[#906C24] text-white font-bold rounded-lg hover:opacity-80 transition uppercase self-center">Participe da pesquisa</Link>
        </section>
      </main>
    </LoadPage>
  )
